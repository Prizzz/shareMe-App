      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
            ...
            {!imageAsset ? (
              <label>
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="mt-20 text-gray-400 text-sm text-center">
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          <input
            ...
            className="outline-none font-bold border-b-2 border-gray-200 p-1"
          />
          {user && (
          ...
          <input
            ...
            className="outline-none font-base border-b-2 border-gray-200 p-1"
          />
          <input
            type="text"
            value={destination}
