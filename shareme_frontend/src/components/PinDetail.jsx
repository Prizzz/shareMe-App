  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          ...
          >
            ...
            />
            <p className="relative t-2 font-semibold capitalize">{pinDetail.postedBy?.userName}</p>
          </Link>
      ...
      {pins?.length > 0 ? (
        ...
        <h2 className="text-center font-bold text-2xl mt-8 mb-4">There are no similar pins</h2>
      )}
    </>
  );
};
